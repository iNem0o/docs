...
* [References](resources/references/README.md)
  ...
  * [Architecture Reference](adr/README.md)
    * [Api](adr/api/README.md)
      * [Removing api version](adr/api/2020-12-02-removing-api-version.md)
      * [Controller configuration route defaults](adr/api/2022-02-09-controller-configuration-route-defaults.md)
      * [Add login required annotation](adr/api/2020-11-20-add-login-required-annotation.md)
    * [Cache](adr/cache/README.md)
      * [Cache stampede protection](adr/cache/2022-03-25-cache-stampede-protection.md)
    * [Storefront](adr/storefront/README.md)
      * [Refactor theme inheritance](adr/storefront/2021-09-22-refactor-theme-inheritance.md)
      * [Move storefront scripts to head](adr/storefront/2021-07-22-move-storefront-scripts-to-head.md)
      * [Add feature flag support for storefront scss](adr/storefront/2022-01-05-add-feature-flag-support-for-storefront-scss.md)
    * [Inventory](adr/inventory/README.md)
      * [Available stock](adr/inventory/2022-03-25-available-stock.md)
    * [Admin](adr/admin/README.md)
      * [Introduce jest fail on console](adr/admin/2021-06-14-introduce-jest-fail-on-console.md)
      * [Introduce eslint on vue admin](adr/admin/2021-05-28-introduce-eslint-on-vue-admin.md)
      * [Add possibility for plugin to add a html file](adr/admin/2021-11-23-add-possibility-for-plugin-to-add-a-html-file.md)
      * [The best practice to always re fetch the data after saving](adr/admin/2020-12-03-the-best-practice-to-always-re-fetch-the-data-after-saving.md)
    ...
    * [Dal](adr/dal/README.md)
      * [Dal join filter](adr/dal/2020-11-19-dal-join-filter.md)
      * [Control clone behavior](adr/dal/2020-07-02-control-clone-behavior.md)
      * [Specify priority of translations in dal write payloads](adr/dal/2022-03-29-specify-priority-of-translations-in-dal-write-payloads.md)
    * [Workflow](adr/workflow/README.md)
      * [Deprecation strategy](adr/workflow/2021-01-21-deprecation-strategy.md)
      * [Adjust ADR approval rules](adr/workflow/2021-11-05-adjust-ADR-approval-rules.md)
      * [Consistent deprecation notices in core](adr/workflow/2022-02-28-consistent-deprecation-notices-in-core.md)
      * [Implement New Changelog](adr/workflow/2020-08-03-implement-New-Changelog.md)
      * [Feature flag system](adr/workflow/2020-08-10-feature-flag-system.md)
      * [Remove static analysis with psalm](adr/workflow/2022-05-12-remove-static-analysis-with-psalm.md)
      * [Implement architecture decision records](adr/workflow/2020-06-25-implement-architecture-decision-records.md)
    * [Performance](adr/performance/README.md)
      * [Increment pattern](adr/performance/2021-11-09-increment-pattern.md)
      * [Profiler integrations](adr/performance/2022-03-25-profiler-integrations.md)
    ...
    * [App](adr/app/README.md)
      * [Integrate app into flow action](adr/app/2022-04-19-integrate-app-into-flow-action.md)
      * [Rule scripting in apps](adr/app/2022-02-21-rule-scripting-in-apps.md)
      * [Custom app api endpoints](adr/app/2022-01-06-custom-app-api-endpoints.md)
      * [App scripting](adr/app/2021-10-21-app-scripting.md)
      * [Implement app system inside platform](adr/app/2020-08-12-implement-app-system-inside-platform.md)
    * [Checkout](adr/checkout/README.md)
      * [Make core mail templates independent from storefront urls](adr/checkout/2021-09-06-make-core-mail-templates-independent-from-storefront-urls.md)
      * [Payment flow](adr/checkout/2021-10-01-payment-flow.md)
      * [Nested line items](adr/checkout/2021-03-24-nested-line-items.md)
      * [Merchant registration](adr/checkout/2020-08-14-merchant-registration.md)
      * [Document template refactoring](adr/checkout/2020-08-12-document-template-refactoring.md)
      * [Tax providers](adr/checkout/2022-04-28-tax-providers.md)
      * [New nested line items](adr/checkout/2022-03-17-new-nested-line-items.md)
    * [Extension](adr/extension/README.md)
      * [Decoration pattern](adr/extension/2020-11-25-decoration-pattern.md)
      * [Custom field label loading in storefront](adr/extension/2020-09-08-custom-field-label-loading-in-storefront.md)
    * [Rule](adr/rule/README.md)
    * [Deployment](adr/deployment/README.md)
